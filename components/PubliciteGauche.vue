<template>
  <div>
    ...
    2xl:w-[15%] 2xl:h-[20%] 2xl:px-0 2xl:left-1 2xl:text-xs 2xl:pt-0 2xl:ml-[15%] 2xl:top-[30%]
    ">
   ...
   <div class="animate-pulse-slow fixed bottom-[21%] left-5   text-lg text-black py-5 px-4 shadow-2xl  h-[30%] w-[15%] 
    ...
    lg:w-[15%] lg:h-[10%] lg:px-0 lg:left-1 lg:text-xs lg:pt-0 lg:ml-[5%] lg:bottom-[20%]
    xl:w-[15%] xl:h-[10%] xl:px-0 xl:left-1 xl:text-xs xl:pt-0 xl:ml-[10%] xl:bottom-[20%]
    2xl:w-[15%] 2xl:h-[20%] 2xl:px-0 2xl:left-1 2xl:text-xs 2xl:pt-0 2xl:ml-[15%] 2xl:bottom-[30%]
   ">
