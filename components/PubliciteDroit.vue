<template>
  <div class="relative bg-white sm:hidden">
    ...
    <div class=" bg-white px-4 text-slate-800 dark:text-gray-200 dark:bg-slate-500
     animate-pulse-slow fixed bottom-[35%] right-2   text-lgshadow-md h-[30%] w-[15%] 
    sm:w-[25%] sm:h-[16%] sm:top-[23%] sm:px-0 sm:pt-0 sm:text-xs sm:left-[75%]
    md:w-[20%] md:h-[18%] md:top-[27%] md:px-0 md:pt-0 md:text-xs
    lg:w-[18%] lg:h-[20%] lg:top-[27%] lg:px-0 lg:pt-0 lg:text-xs
    xl:w-[15%] xl:h-[22%] xl:top-[27%] xl:px-0 xl:pt-0 xl:text-xs xl:mx-[8%]
    2xl:w-[15%] 2xl:h-[23%] 2xl:top-[27%] 2xl:px-0 2xl:pt-0 2xl:text-xs 2xl:mr-[10%] 
    ">
