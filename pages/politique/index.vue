  ...
  <div>
    <ContentList path="/politique"  :query="query" >
       <template #default="{list}">
        ...
        ">
          <div v-for="(politique, index) in list" :key="index" class="shadow-md round-2xl mb-1 border-2 border-[#aaba]  rounded-2xl
          ...
          ">
            ...
            <p v-if="politique.description">{{ politique.description }}</p>
            <p>{{ formatDate(politique.date) }}</p>
          </div>
        </div>
